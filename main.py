...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://graph.org/file/734713c9cba1c73ac3518-9be4248ab71475d122.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://cpapi-rjbs-1l0p.onrender.com/extract_keys?url={url}@bots_updatee&user_id={8362916972}"
                ...
                signed_api = f"https://cpapi-rjbs-1l0p.onrender.com/extract_keys?url={url}@bots_updatee&user_id={8362916972}"
            ...
            try:
                if raw_text5 == "yes":
                    ...
                    cc = f'.𖥔 ݁ ˖Vid Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {v_name}\n\n<blockquote><b>✘ Course : {b_name}</b></blockquote>\n<blockquote><b>✎ᝰ.Topic : {t_name}</b></blockquote>\n\n**Downloaded By-**{CR}\n'
                    cc1 = f'.𖥔 ݁ ˖Pdf Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {v_name}\n\n<blockquote><b>✘ Course : {b_name}</b></blockquote>\n<blockquote><b>✎ᝰ.Topic : {t_name}</b></blockquote>\n\n**Downloaded By-**{CR}\n'
                    cczip = f'.𖥔 ݁ ˖Zip Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {v_name}\n\n<blockquote><b>✘ Course : {b_name}</b></blockquote>\n<blockquote><b>✎ᝰ.Topic : {t_name}</b></blockquote>\n\n**Downloaded By-**{CR}\n'
                    ccimg = f'.𖥔 ݁ ˖Img Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {v_name}\n\n<blockquote><b>✘ Course : {b_name}</b></blockquote>\n<blockquote><b>✎ᝰ.Topic : {t_name}</b></blockquote>\n\n**Downloaded By-**{CR}\n'
                    cchtml = f'.𖥔 ݁ ˖Html Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {v_name}\n\n<blockquote><b>✘ Course : {b_name}</b></blockquote>\n<blockquote><b>✎ᝰ.Topic : {t_name}</b></blockquote>\n\n**Downloaded By-**{CR}\n'
                    ccyt = f'.𖥔 ݁ ˖Vid Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {v_name}\n\n<a href="{url}">__**Click Here to Watch Stream**__</a>\n<blockquote><b>✘ Course : {b_name}</b></blockquote>\n<blockquote><b>✎ᝰ.Topic : {t_name}</b></blockquote>\n\n**Downloaded By-**{CR}\n'
                    ccm = f'.𖥔 ݁ ˖Mp3 Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {v_name}\n\n<blockquote><b>✘ Course : {b_name}</b></blockquote>\n<blockquote><b>✎ᝰ.Topic : {t_name}</b></blockquote>\n\n**Downloaded By-**{CR}\n'
                else:
                    cc = f'.𖥔 ݁ ˖Vid Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {name1} \n\n<blockquote><b>✘ Course :</b> {b_name}</blockquote>\n\n**Downloaded By-**{CR}\n'
                cc1 = f'.𖥔 ݁ ˖Pdf Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {name1}\n\n<blockquote><b>✘ Course :</b> {b_name}</blockquote>\n\n**Downloaded By-**{CR}\n'
                cczip = f'.𖥔 ݁ ˖Zip Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {name1}\n\n<blockquote><b> ✘ Course :</b> {b_name}</blockquote>\n\n**Downloaded By-**{CR}\n' 
                ccimg = f'.𖥔 ݁ ˖Img Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {name1}\n\n<blockquote><b>✘ Course :</b> {b_name}</blockquote>\n\n**Downloaded By-**{CR}\n'
                ccm = f'.𖥔 ݁ ˖Audio Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {name1}\n\n<blockquote><b>✘  Course :</b> {b_name}</blockquote>\n\n**Downloaded By-**{CR}\n'
                cchtml = f'.𖥔 ݁ ˖Html Id.𖥔 ݁ ˖ : {str(count).zfill(3)}\n\n**Title :** {name1}\n\n<blockquote><b>✘ Course :</b> {b_name}</blockquote>\n\n**Downloaded By-**{CR}\n'
...
async def text_handler(bot: Client, m: Message):
    ...
    try:
            ...
            if "acecwply" in url:
                ...
                url = url.replace("https://cpvod.testbook.com/","https://media-cdn.classplusapp.com/drm/")
                url = f"https://cpapi-rjbs.onrender.com/extract_keys?url={url}@bots_updatee&user_id={8362916972}"
                #url = f"https://scammer-keys.vercel.app/api?url={url}&token={cptoken}&auth=@scammer_botxz1"
                mpd, keys = helper.get_mps_and_keys(url)
                url = mpd
                keys_string = " ".join([f"--key {key}" for key in keys])
                ...
                signed_api = f"https://cpapi-rjbs.onrender.com/extract_keys?url={url}@bots_updatee&user_id={8362916972}"
                response = requests.get(signed_api, timeout=20)
                #url = response.text.strip()
                url = response.json()['url']  
